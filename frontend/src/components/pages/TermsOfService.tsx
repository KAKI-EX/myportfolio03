    ...
    <Box p={5}>
      <Center>
        <Heading mb={5} size={headingFontSize}>
          OkaimonoMemoサービス利用規約
        </Heading>
      </Center>
      <VStack align="start" spacing={5}>
        <Text mb={5} fontSize={textFontSize}>
          この規約は、お客様が、私個人（アプリ制作者）が提供する「OkaimonoMemo」サービス（以下「本サービス」）をご利用頂く際の取扱いにつき定めるものです。本規約に同意した上で本サービスをご利用ください。
        </Text>
        ...
        <Text mb={5} fontSize={textFontSize}>
          ...
          <br />
          ２  利用者が、本サービスをスマートフォンその他の情報端末にダウンロードし、本規約への同意手続を行った時点で、利用者と私個人（アプリ制作者）との間で、本規約の諸規定に従った利用契約が成立するものとします。
          <br />
          ３  利用者が未成年者である場合には、親権者その他の法定代理人の同意を得たうえで、本サービスをご利用ください。
          <br />
          ４  未成年者の利用者が、法定代理人の同意がないにもかかわらず同意があると偽りまたは年齢について成年と偽って本サービスを利用した場合、その他行為能力者であることを信じさせるために詐術を用いて本サービスを利用した場合、本サービスに関する一切の法律行為は取り消しできません。
          <br />
          ５  未成年者が本サービスを利用するにあたっては、法定代理人を含む利用者の責任において、本サービスの内容を十分に理解した上で本サービスを利用するものとします。
          <br />
          ６  利用者が利用登録をした場合、利用者は、利用登録の時点で本利用規約に同意したものとみなします。
        </Text>
        <Heading size="md" mb={2}>
          第３条（利用登録）
        </Heading>
        <Text mb={5} fontSize={textFontSize}>
          １  本サービスの利用を希望する者（以下「登録希望者」といいます。）は、私個人（アプリ制作者）の定める方法により、利用登録を申請するものとします。
          <br />
          ２  私個人（アプリ制作者）は、登録希望者が以下の各号のいずれかに該当する場合、利用登録を拒否することがあります。
          <br />
          ...
          <br />
          ４  利用登録が効力を生じたことにより、登録希望者は利用者となり、私個人（アプリ制作者）が提供する本サービスを、本規約の定めに従って利用することができるようになります。
        </Text>
        <Heading size="md" mb={2}>
          第４条（ユーザーID及びパスワードの管理）
        </Heading>
        <Text mb={5} fontSize={textFontSize}>
          １  利用者は、自己の責任において、ユーザーID及びパスワードを管理及び保管するものとし、これを第三者に利用させ、または貸与、譲渡、名義変更、売買などをしてはならないものとします。
          <br />
          ２  ユーザーID及びパスワードの管理不十分、使用上の過誤、第三者の使用等によって生じた損害について、私個人（アプリ制作者）は一切の責任を負いません。
        </Text>
        <Heading size="md" mb={2}>
          第５条（利用料金及び支払方法）
        </Heading>
        <Text mb={5} fontSize={textFontSize}>
          １  利用者は、本サービスの利用にあたり、私個人（アプリ制作者）が別途定め、本サイトに表示する利用料金を、私個人（アプリ制作者）が指定する方法により支払うものとします。
          <br />
          ２  利用者が利用料金の支払を遅滞した場合、利用者は、年間14.6％の割合による遅延損害金を支払うものとします。
        </Text>
        <Heading size="md" mb={2}>
          第６条（禁止事項）
        </Heading>
        ...
        <Text mb={5} fontSize={textFontSize}>
          １  私個人（アプリ制作者）は、以下のいずれかの事由があると判断した場合、利用者に事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。
          <br />
          ...
          <br />
          ２  私個人（アプリ制作者）は、本サービスの提供の停止または中断により、利用者または第三者が被ったいかなる損害についても、理由を問わず一切の責任を負わないものとします。
        </Text>
        <Heading size="md" mb={2}>
          第８条（利用契約の解除等）
        </Heading>
        <Text mb={5} fontSize={textFontSize}>
          １  私個人（アプリ制作者）は、利用者が以下の各号のいずれかに該当する場合、事前の通知なくして利用契約を解除し、または本サービスの利用を一時停止することができるものとします。
          <br />
          ...
          <br />
          ２  前各号のいずれかに該当した場合、利用者は、当然に私個人（アプリ制作者）に対して、当該利用者の利用する本サービスに関連して生じた一切の債務について期限の利益を失うものとします。
          <br />
          ３  私個人（アプリ制作者）の前各号に基づく利用契約の解除、または本サービスの利用の一時停止により、利用者または第三者が被ったいかなる損害についても、理由を問わず一切の責任を負わないものとします。
        </Text>
        <Heading size="md" mb={2}>
          第９条（保証の否認及び免責事項）
        </Heading>
        <Text mb={5} fontSize={textFontSize}>
          １  私個人（アプリ制作者）は、本サービスに関して、特定の目的への適合性、完全性、確実性、安全性、合法性、最新性及び無違反性について、明示または黙示を問わず、何ら保証しません。
          <br />
          ２  私個人（アプリ制作者）は、本サービスに起因して利用者に生じたあらゆる損害について、一切の責任を負いません。ただし、本サービスの利用契約（これに関連する契約を含みます。以下本条において同じ。）が消費者契約法第2条第3項に定義される消費者契約となる場合、この免責規定は適用しません。
          <br />
          ３  前項の場合、私個人（アプリ制作者）は、過失による場合に限り、利用者が本サービスの利用により被った通常の損害についての責任を負います。ただし、この損害賠償の責任は、利用者からの当該損害が発生した月に受領した利用料金の額を上限とします。
        </Text>
        <Heading size="md" mb={2}>
          第１０条（サービス内容の変更等）
        </Heading>
        ...
        <Text mb={5} fontSize={textFontSize}>
          ...
          <br />
          ２  本サービスに関して紛争が生じた場合には、私個人（アプリ制作者）の本店所在地を管轄する裁判所を専属的合意管轄とします。
        </Text>
        <Text mb={5}>以上</Text>
      </VStack>
    </Box>
